...
void SPDIF_IRQHandler              	(void) __attribute__ ((weak, alias("Default_Handler"))); 
void FMPI2C1_IRQHandler             (void) __attribute__ ((weak, alias("Default_Handler")));
void FMPI2C1_ERRORIRQHandler        (void) __attribute__ ((weak, alias("Default_Handler")));
...
uint32_t vectors[] __attribute__((section(".isr_vector"))) = {
	...
	(uint32_t)&FMPI2C1_ERRORIRQHandler
